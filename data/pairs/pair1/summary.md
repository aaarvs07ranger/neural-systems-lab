...
- `SoapBar|distractor|0` (SoapBar, `Soap_Bar_1`) on `Dresser|2|1`
- `Vase|distractor|1` (Vase, `Vase_Tall_3`) on `Dresser|2|1`
- `Desktop|distractor|2` (Desktop, `Desktop_316_1`) on `Dresser|2|1`
- `CellPhone|distractor|3` (CellPhone, `Cellphone_3`) on `Dresser|2|1`
