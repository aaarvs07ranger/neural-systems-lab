...
- `Bottle|distractor|0` (Bottle, `Bottle_1`) on `Sofa|3|0|1`
- `SoapBar|distractor|1` (SoapBar, `Soap_Bar_1`) on `Sofa|3|0|1`
- `WineBottle|distractor|2` (WineBottle, `Wine_Bottle_1`) on `Fridge|2|1`
- `Laptop|distractor|3` (Laptop, `Laptop_7`) on `TVStand|3|0|0`
- `TissueBox|distractor|4` (TissueBox, `Tissue_Box_1`) on `DiningTable|3|1`
- `DishSponge|distractor|5` (DishSponge, `Dish_Sponge_1`) on `TVStand|3|0|0`
- `Dumbbell|distractor|6` (Dumbbell, `Dumbbell_1_1`) on `TVStand|3|0|0`
- `SaltShaker|distractor|7` (SaltShaker, `RoboTHOR_salt_pepper_shaker_bnyd_salt_v`) on `CounterTop|2|0`
