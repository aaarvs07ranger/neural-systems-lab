...
class WorldModel(nn.Module):
	...
	def init(self):
		# De-vectorized target Q-networks (see ../VENDOR.md): a plain frozen
		# deepcopy, Polyak-averaged in soft_update_target_Q(). The upstream
		# detached-params view is provided by Ensemble(detach_params=True).
	...
	def Q(self, z, a, task, return_type='min', target=False, detach=False):
		...
		if target:
			...
			out = self._Qs(z, detach_params=True)
		else:
			out = self._Qs(z)
