...
- `CD|distractor|0` (CD, `CD_1`) on `Toilet|3|0`
- `SprayBottle|distractor|1` (SprayBottle, `Spray_Bottle_8`) on `Dresser|2|1`
- `Television|distractor|2` (Television, `Television_30`) on `Sink|3|1|0`
- `TissueBox|distractor|3` (TissueBox, `Tissue_Box_1`) on `Toilet|3|0`
- `PaperTowelRoll|distractor|4` (PaperTowelRoll, `Paper_Towel_1`) on `Sink|3|1|0`
- `Pan|distractor|5` (Pan, `Pan_6`) on `Sink|3|1|0`
- `Spoon|distractor|6` (Spoon, `Spoon_1`) on `Dresser|2|1`
- `Ladle|distractor|7` (Ladle, `Ladle_1`) on `DiningTable|2|2|0`
